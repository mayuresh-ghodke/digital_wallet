...
- `ddl-auto: update` and H2 are used for local/demo simplicity; a production deployment would use versioned migrations (Flyway/Liquibase) against a persistent RDBMS (e.g. PostgreSQL).
